...
public class ActivityUpdate extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        editText_minute =  (EditText) findViewById(R.id.activity_insert_edittext_minute);
        spinner_type = (Spinner) findViewById(R.id.activity_insert_spinner_type);
        textView_date = (TextView) findViewById(R.id.activity_insert_date);
        textView_time = (TextView) findViewById(R.id.activity_insert_time);
        textView_comment = (TextView) findViewById(R.id.activity_insert_textview_comment);
